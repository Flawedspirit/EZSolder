...
return array(
    ...
    'err_not_writable'  => "The repository at <strong>%s</strong> is not writable by this application. You must fix this before this application will function properly.",
    ...
    'label_dest_mods'   => "/mods",
    'label_dest_conf'   => "/config",
    'label_dest_bin'    => "/bin",
